                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('send')}}" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="validationCustom02">عنوان الرسالة</label>
                                    <input type="text" name="title" class="form-control" id="validationCustom02"
                                           placeholder="عنوان الرسالة" value="{{ old('title') }}" required>
                                    @error('title')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="validationCustom05">محتوى الرسالة</label>
                                    <textarea type="text" name="msg" class="form-control" id="validationCustom05"
                                              placeholder="محتوى الرسالة" value="{{ old('msg') }}" required></textarea>
                                    @error('msg')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
